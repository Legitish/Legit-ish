...
public class CompCombo extends Comp {
    ...
    public void drawScreen(int mouseX, int mouseY, double scrollY) {
        ...
        RoundedUtils.drawRound((float) (clickGui.getX() + x - 70), (float) (clickGui.getY() + y), (float) FontUtils.regular20.getStringWidth(comboSetting.get() + ": " + comboSetting.getValue()) + 5, 11, 3, ColorUtils.getBackgroundColor(2));
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        if (MouseUtils.isInside(mouseX, mouseY, clickGui.getX() + x - 70, clickGui.getY() + y, 70, 10) && mouseButton == 0) {
