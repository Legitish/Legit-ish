...
public class CompDoubleSlider extends Comp {
    ...
    public void drawScreen(int mouseX, int mouseY, double scrollY) {
        ...
        RRectUtils.drawGradientRoundCorner(clickGui.getX() + x + animationMin.getValue() - 3, clickGui.getY() + y + 10.75, 6, 6, 2.5);
        RRectUtils.drawGradientRoundCorner(clickGui.getX() + x + animationMax.getValue() - 3, clickGui.getY() + y + 10.75, 6, 6, 2.5);
